import { Box, Container, Flex, Heading, Image, ListItem, Text, UnorderedList } from "@chakra-ui/react";
  ...
  return (
    <Container mt={20} mb={10} maxW={900}>
      ...
      <Box>
        ...
        <Text>After clicking on the Google button, a window will open and you can select your google account. The page will look like this;</Text> 
 <Image
        ...
        <Text>
          ...
          can be able to register the document. You can then fill out the infomation and required, and then choose a picture of the document from your device. This is what it will look like;
        </Text>
        <Image
        ...
        <Text>After choosing the image, you should then click the upload button and then click on send respectively as indicated below.</Text>
        ...
        <Text>After clicking send, a confirmation window will pop, just check if everything is okay and send.</Text>
      </Box>
    </Container>
  );
};
